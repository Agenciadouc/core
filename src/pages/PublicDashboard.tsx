    ...
    <div className="public-dashboard">
      ...
      {loadingData ? (
        ...
        <>
          ...
          <section className="dash-section"><div className="table-card"><div className="table-header"><h3>Campanhas</h3></div><CampaignTree currentCampaigns={campaignCompare?.current || []} days={getEffectiveDays()} since={datePeriod === 'custom' ? customFrom : undefined} until={datePeriod === 'custom' ? customTo : undefined} columns={config.table} accountId={accountId} /></div></section>
